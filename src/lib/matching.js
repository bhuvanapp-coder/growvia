...
export function matchOpportunity(studentDNA, opportunity) {
  ...
  const currentSkills = list(dna.currentSkills)
  ...
  return { matchScore: score, category, categoryLabel, why: reason, matchingSkills, missingSkills, growthValue: opportunity.growthValue || (growthMatches.length ? `Build confidence in ${growthMatches.join(' and ')}` : 'Explore a new direction with a beginner-friendly format.') }
}
...
export const demoStudentDNA = { currentSkills: ['Python', 'React', 'Git & GitHub'], interests: ['AI / ML', 'Web development', 'Community'], growthGoals: ['Technical skills', 'Communication', 'Problem solving'], preferredTypes: ['Hackathons', 'Workshops', 'Conferences'], locationPreferences: ['Online'], dreamOpportunities: ['AI / ML hackathons', 'Top tech conferences'] }
